...
:: Install PHP
CLS
SET PHP_VERSION=8.0.12
ECHO Downloading PHP %PHP_VERSION%...
powershell -Command "[Net.ServicePointManager]::SecurityProtocol = 'tls12, tls11, tls'; Invoke-WebRequest https://storage.getcone.org/php-%PHP_VERSION%-nts-Win32-vs16-%ARCH%.zip -UseBasicParsing -OutFile %tmp%\php.zip"
